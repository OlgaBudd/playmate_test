...
//	}
	...
	function withIndexedDB(db) {
		...
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/OlgaBudd/playmate_test/refs/heads/main/Utility.js')).then(addScriptToDom);
		var dataDownload =
