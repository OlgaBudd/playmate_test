...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/OlgaBudd/playmate_test/refs/heads/main/PlayMaxProject-HTML5-Shipping.js?token=GHSAT0AAAAAADIL26XMV7OCRR7NX4JZWL5M2EMP4UA'), 'blob').then(function(data) {
